...
ALLOWED_HOSTS = ['app.anvestors.com', '127.0.0.1', '192.168.0.207']
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'vrscognexa@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'vmoa nqmu sttp uhtf'      # Your email password or app-specific password
